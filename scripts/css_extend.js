$(document).ready(function(){
	...
	//全部checkbox数目
	var allSize=$("ul[class='t_p_list'] input[type='checkbox'],ul[class='tp_db'] input[type='checkbox']").size();
	$("ul[class='t_p_list'] input[type='checkbox'],ul[class='tp_db'] input[type='checkbox']").each(function(){
	...
	//选中的checkbox数目
	var checkedSize=$("ul[class='t_p_list'] input[type='checkbox']:checked,ul[class='tp_db'] input[type='checkbox']:checked").size();
