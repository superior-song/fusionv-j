...
var IMAGESPATH = '../facedetection/commons/scripts/popping/images/'; //图片路径配置
...
Dialog.getBgdiv = function () {
    ...
    if (!bgdiv) {
		...
		var bgIframeMask = '<div id="_DialogBGMask" style="position:absolute;background:#010b25;opacity:0.2;filter:alpha(opacity=20);width:100%;height:100%;overflow:auto;"></div>';
