...
Pager.prototype.toString = function (){
	...
	switch (this.lang) {
		case "cn":
			...
			pagerStrings[pagerStrings.length] = '<input name="buttonsubmitPage" type="submit" id="buttonsubmitPage" value="\u8f6c\u5230" onclick="this.form.requestPage.value = isInteger(this.form.requestPage.value) ? this.form.requestPage.value : 1" />';
			break;
		default:
