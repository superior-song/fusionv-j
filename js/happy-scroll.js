...
(function(global, factory) {
    ...
    var HappyScrollStrip = {
        render: function render() {
            ...
            return _c('div', {
                ...
                class: [_vm.horizontal ? 'happy-scroll-strip--horizontal' : 'happy-scroll-strip--vertical'],
                style: [_vm.initLocation],
                on: {
                    "!wheel": function wheel($event) {
                        $event.stopPropagation();
                        _vm.handlerWheel($event);
                    }
                }
            }, [_c('div', {
                ref: "strip",
                staticClass: "happy-scroll-bar",
                style: [_vm.translate, _defineProperty({}, _vm.config.sizeAttr, _vm.length + 'px'), _vm.initSize, { background: _vm.color }, { opacity: _vm.isOpacity }],
                on: {
                    "mousedown": function mousedown($event) {
                        $event.stopPropagation();
                        _vm.handlerMouseDown($event);
                    }
                }
            })]);
        },
    ...
    var HappyScroll = {
        render: function render() {
            ...
            var _h = _vm.$createElement;
            var _c = _vm._self._c || _h;
            return _c('div', { ref: "happy-scroll", staticClass: "happy-scroll" }, [_c('div', {
                ref: "container",
